...
// 对指定时间区间的 IMU 数据积分，得到视觉诊断所需的相对旋转和平移。
// This is the unchanged implementation formerly colocated with the legacy
// integrated LiDAR matcher.
bool DogPriorMapEkfNode::integrateImuDelta(double t0, double t1,
                                           Eigen::Matrix3d &R_delta,
                                           Eigen::Vector3d &p_delta) const
{
